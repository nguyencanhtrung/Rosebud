...
// Component : VexRiscv
// Git hash  : c593d5963897f544cc33502bbcb73f24de4f834d
...
module VexRiscv (
  ...
  assign _zz_127 = (writeBack_arbitration_isValid && writeBack_REGFILE_WRITE_VALID);
  assign _zz_128 = 1'b1;
  assign _zz_129 = (memory_arbitration_isValid && memory_REGFILE_WRITE_VALID);
  assign _zz_130 = (execute_arbitration_isValid && execute_REGFILE_WRITE_VALID);
  assign _zz_131 = (execute_arbitration_isValid && execute_IS_CSR);
  assign _zz_132 = (CsrPlugin_hadException || CsrPlugin_interruptJump);
  assign _zz_133 = (writeBack_arbitration_isValid && (writeBack_ENV_CTRL == `EnvCtrlEnum_defaultEncoding_XRET));
  assign _zz_134 = writeBack_INSTRUCTION[29 : 28];
  assign _zz_135 = ((dBus_rsp_ready && dBus_rsp_error) && (! memory_MEMORY_STORE));
  assign _zz_136 = (CsrPlugin_privilege < execute_CsrPlugin_csrAddress[9 : 8]);
  assign _zz_137 = (writeBack_arbitration_isValid && writeBack_REGFILE_WRITE_VALID);
  assign _zz_138 = (1'b0 || (! 1'b1));
  assign _zz_139 = (memory_arbitration_isValid && memory_REGFILE_WRITE_VALID);
  assign _zz_140 = (1'b0 || (! memory_BYPASSABLE_MEMORY_STAGE));
  assign _zz_141 = (execute_arbitration_isValid && execute_REGFILE_WRITE_VALID);
  assign _zz_142 = (1'b0 || (! execute_BYPASSABLE_EXECUTE_STAGE));
  assign _zz_143 = (CsrPlugin_mstatus_MIE || (CsrPlugin_privilege < 2'b11));
  assign _zz_144 = ((_zz_72 && 1'b1) && (! 1'b0));
  assign _zz_145 = ((_zz_73 && 1'b1) && (! 1'b0));
  assign _zz_146 = ((_zz_74 && 1'b1) && (! 1'b0));
  assign _zz_147 = memory_INSTRUCTION[13 : 12];
  assign _zz_148 = execute_INSTRUCTION[13];
  assign _zz_149 = ($signed(_zz_151) >>> execute_FullBarrelShifterPlugin_amplitude);
  assign _zz_150 = _zz_149[31 : 0];
  assign _zz_151 = {((execute_SHIFT_CTRL == `ShiftCtrlEnum_defaultEncoding_SRA_1) && execute_FullBarrelShifterPlugin_reversed[31]),execute_FullBarrelShifterPlugin_reversed};
  assign _zz_152 = _zz_75[17 : 17];
  assign _zz_153 = _zz_75[15 : 15];
  assign _zz_154 = _zz_75[12 : 12];
  assign _zz_155 = _zz_75[11 : 11];
  assign _zz_156 = _zz_75[10 : 10];
  assign _zz_157 = _zz_75[3 : 3];
  assign _zz_158 = _zz_75[14 : 14];
  assign _zz_159 = _zz_75[4 : 4];
  assign _zz_160 = _zz_75[2 : 2];
  assign _zz_161 = _zz_75[20 : 20];
  assign _zz_162 = _zz_75[9 : 9];
  assign _zz_163 = (_zz_53 & (~ _zz_164));
  assign _zz_164 = (_zz_53 - 2'b01);
  assign _zz_165 = {IBusSimplePlugin_fetchPc_inc,2'b00};
  assign _zz_166 = {29'd0, _zz_165};
  assign _zz_167 = (IBusSimplePlugin_pending_value + _zz_169);
  assign _zz_168 = IBusSimplePlugin_pending_inc;
  assign _zz_169 = {2'd0, _zz_168};
  assign _zz_170 = IBusSimplePlugin_pending_dec;
  assign _zz_171 = {2'd0, _zz_170};
  assign _zz_172 = (IBusSimplePlugin_rspJoin_rspBuffer_c_io_pop_valid && (IBusSimplePlugin_rspJoin_rspBuffer_discardCounter != 3'b000));
  assign _zz_173 = {2'd0, _zz_172};
  assign _zz_174 = IBusSimplePlugin_pending_dec;
  assign _zz_175 = {2'd0, _zz_174};
  assign _zz_176 = (memory_MEMORY_STORE ? 3'b110 : 3'b100);
  assign _zz_177 = execute_SRC_LESS;
  assign _zz_178 = 3'b100;
  assign _zz_179 = execute_INSTRUCTION[19 : 15];
  assign _zz_180 = execute_INSTRUCTION[31 : 20];
  assign _zz_181 = {execute_INSTRUCTION[31 : 25],execute_INSTRUCTION[11 : 7]};
  assign _zz_182 = ($signed(_zz_183) + $signed(_zz_186));
  assign _zz_183 = ($signed(_zz_184) + $signed(_zz_185));
  assign _zz_184 = execute_SRC1;
  assign _zz_185 = (execute_SRC_USE_SUB_LESS ? (~ execute_SRC2) : execute_SRC2);
  assign _zz_186 = (execute_SRC_USE_SUB_LESS ? _zz_187 : _zz_188);
  assign _zz_187 = 32'h00000001;
  ...
  assign _zz_194 = execute_CsrPlugin_writeData[3 : 3];
  assign _zz_195 = execute_CsrPlugin_writeData[11 : 11];
  ...
  assign _zz_209 = {((decode_INSTRUCTION & 32'hbc00707f) == 32'h00005013),{((decode_INSTRUCTION & 32'hfc00307f) == 32'h00001013),{((decode_INSTRUCTION & _zz_210) == 32'h00005033),{(_zz_211 == _zz_212),(_zz_213 == _zz_214)}}}};
  assign _zz_210 = 32'hbe00707f;
  assign _zz_211 = (decode_INSTRUCTION & 32'hbe00707f);
  assign _zz_212 = 32'h00000033;
  assign _zz_213 = (decode_INSTRUCTION & 32'hdfffffff);
  assign _zz_214 = 32'h10200073;
  assign _zz_215 = (decode_INSTRUCTION & 32'h0000001c);
  assign _zz_216 = 32'h00000004;
  assign _zz_217 = (decode_INSTRUCTION & 32'h00000058);
  assign _zz_218 = 32'h00000040;
  assign _zz_219 = ((decode_INSTRUCTION & 32'h00007054) == 32'h00005010);
  assign _zz_220 = {(_zz_225 == _zz_226),(_zz_227 == _zz_228)};
  assign _zz_221 = 2'b00;
  assign _zz_222 = ((_zz_229 == _zz_230) != 1'b0);
  assign _zz_223 = (_zz_231 != 1'b0);
  assign _zz_224 = {(_zz_232 != _zz_233),{_zz_234,{_zz_235,_zz_236}}};
  assign _zz_225 = (decode_INSTRUCTION & 32'h40003054);
  assign _zz_226 = 32'h40001010;
  assign _zz_227 = (decode_INSTRUCTION & 32'h00007054);
  assign _zz_228 = 32'h00001010;
  assign _zz_229 = (decode_INSTRUCTION & 32'h00000064);
  assign _zz_230 = 32'h00000024;
  assign _zz_231 = ((decode_INSTRUCTION & 32'h00001000) == 32'h00001000);
  assign _zz_232 = ((decode_INSTRUCTION & 32'h00003000) == 32'h00002000);
  assign _zz_233 = 1'b0;
  assign _zz_234 = ({(_zz_237 == _zz_238),(_zz_239 == _zz_240)} != 2'b00);
  assign _zz_235 = ((_zz_241 == _zz_242) != 1'b0);
  assign _zz_236 = {({_zz_243,_zz_244} != 2'b00),{(_zz_245 != _zz_246),{_zz_247,{_zz_248,_zz_249}}}};
  assign _zz_237 = (decode_INSTRUCTION & 32'h00002010);
  assign _zz_238 = 32'h00002000;
  assign _zz_239 = (decode_INSTRUCTION & 32'h00005000);
  assign _zz_240 = 32'h00001000;
  assign _zz_241 = (decode_INSTRUCTION & 32'h00003050);
  assign _zz_242 = 32'h00000050;
  assign _zz_243 = ((decode_INSTRUCTION & _zz_250) == 32'h00001050);
  assign _zz_244 = ((decode_INSTRUCTION & _zz_251) == 32'h00002050);
  assign _zz_245 = {(_zz_252 == _zz_253),(_zz_254 == _zz_255)};
  assign _zz_246 = 2'b00;
  assign _zz_247 = ({_zz_256,{_zz_257,_zz_258}} != 3'b000);
  assign _zz_248 = (_zz_259 != 1'b0);
  assign _zz_249 = {(_zz_260 != _zz_261),{_zz_262,{_zz_263,_zz_264}}};
  assign _zz_250 = 32'h00001050;
  assign _zz_251 = 32'h00002050;
  assign _zz_252 = (decode_INSTRUCTION & 32'h00000034);
  assign _zz_253 = 32'h00000020;
  assign _zz_254 = (decode_INSTRUCTION & 32'h00000064);
  assign _zz_255 = 32'h00000020;
  assign _zz_256 = ((decode_INSTRUCTION & 32'h00000050) == 32'h00000040);
  assign _zz_257 = ((decode_INSTRUCTION & _zz_265) == 32'h00000040);
  assign _zz_258 = ((decode_INSTRUCTION & _zz_266) == 32'h0);
  assign _zz_259 = ((decode_INSTRUCTION & 32'h00000020) == 32'h00000020);
  assign _zz_260 = ((decode_INSTRUCTION & _zz_267) == 32'h0);
  assign _zz_261 = 1'b0;
  assign _zz_262 = ({_zz_77,{_zz_268,_zz_269}} != 3'b000);
  assign _zz_263 = ({_zz_270,_zz_271} != 6'h0);
  assign _zz_264 = {(_zz_272 != _zz_273),{_zz_274,{_zz_275,_zz_276}}};
  assign _zz_265 = 32'h00003040;
  assign _zz_266 = 32'h00000038;
  assign _zz_267 = 32'h0;
  assign _zz_268 = ((decode_INSTRUCTION & _zz_277) == 32'h00002010);
  assign _zz_269 = ((decode_INSTRUCTION & _zz_278) == 32'h00000010);
  assign _zz_270 = _zz_78;
  assign _zz_271 = {(_zz_279 == _zz_280),{_zz_281,{_zz_282,_zz_283}}};
  assign _zz_272 = {_zz_77,(_zz_284 == _zz_285)};
  assign _zz_273 = 2'b00;
  assign _zz_274 = ({_zz_77,_zz_286} != 2'b00);
  assign _zz_275 = (_zz_287 != 1'b0);
  assign _zz_276 = {(_zz_288 != _zz_289),{_zz_290,{_zz_291,_zz_292}}};
  assign _zz_277 = 32'h00002050;
  assign _zz_278 = 32'h00001050;
  assign _zz_279 = (decode_INSTRUCTION & 32'h00001010);
  assign _zz_280 = 32'h00001010;
  assign _zz_281 = ((decode_INSTRUCTION & _zz_293) == 32'h00002010);
  assign _zz_282 = (_zz_294 == _zz_295);
  assign _zz_283 = {_zz_296,_zz_297};
  assign _zz_284 = (decode_INSTRUCTION & 32'h00000070);
  assign _zz_285 = 32'h00000020;
  assign _zz_286 = ((decode_INSTRUCTION & _zz_298) == 32'h0);
  assign _zz_287 = ((decode_INSTRUCTION & _zz_299) == 32'h00004010);
  assign _zz_288 = (_zz_300 == _zz_301);
  assign _zz_289 = 1'b0;
  assign _zz_290 = ({_zz_302,_zz_303} != 4'b0000);
  assign _zz_291 = (_zz_304 != _zz_305);
  assign _zz_292 = {_zz_306,{_zz_307,_zz_308}};
  assign _zz_293 = 32'h00002010;
  assign _zz_294 = (decode_INSTRUCTION & 32'h00000050);
  assign _zz_295 = 32'h00000010;
  assign _zz_296 = ((decode_INSTRUCTION & 32'h0000000c) == 32'h00000004);
  assign _zz_297 = ((decode_INSTRUCTION & 32'h00000028) == 32'h0);
  assign _zz_298 = 32'h00000020;
  assign _zz_299 = 32'h00004014;
  assign _zz_300 = (decode_INSTRUCTION & 32'h00006014);
  assign _zz_301 = 32'h00002010;
  assign _zz_302 = ((decode_INSTRUCTION & _zz_309) == 32'h0);
  assign _zz_303 = {(_zz_310 == _zz_311),{_zz_312,_zz_313}};
  assign _zz_304 = ((decode_INSTRUCTION & _zz_314) == 32'h0);
  assign _zz_305 = 1'b0;
  assign _zz_306 = ({_zz_315,{_zz_316,_zz_317}} != 3'b000);
  assign _zz_307 = ({_zz_318,_zz_319} != 2'b00);
  assign _zz_308 = ({_zz_320,_zz_321} != 2'b00);
  assign _zz_309 = 32'h00000044;
  assign _zz_310 = (decode_INSTRUCTION & 32'h00000018);
  assign _zz_311 = 32'h0;
  assign _zz_312 = ((decode_INSTRUCTION & 32'h00006004) == 32'h00002000);
  assign _zz_313 = ((decode_INSTRUCTION & 32'h00005004) == 32'h00001000);
  assign _zz_314 = 32'h00000058;
  assign _zz_315 = ((decode_INSTRUCTION & 32'h00000044) == 32'h00000040);
  assign _zz_316 = ((decode_INSTRUCTION & 32'h00002014) == 32'h00002010);
  assign _zz_317 = ((decode_INSTRUCTION & 32'h40000034) == 32'h40000030);
  assign _zz_318 = ((decode_INSTRUCTION & 32'h00000014) == 32'h00000004);
  assign _zz_319 = _zz_76;
  assign _zz_320 = ((decode_INSTRUCTION & 32'h00000044) == 32'h00000004);
  assign _zz_321 = _zz_76;
  assign _zz_125 = RegFilePlugin_regFile[decode_RegFilePlugin_regFileReadAddress1];
  assign _zz_126 = RegFilePlugin_regFile[decode_RegFilePlugin_regFileReadAddress2];
  ...
  assign execute_SHIFT_RIGHT = _zz_150;
  ...
  assign decode_IS_CSR = _zz_153[0];
  ...
  assign decode_RS2_USE = _zz_158[0];
  assign decode_RS1_USE = _zz_159[0];
  ...
  assign decode_SRC_USE_SUB_LESS = _zz_160[0];
  assign decode_SRC_ADD_ZERO = _zz_161[0];
  ...
  always @ (*) begin
    decode_REGFILE_WRITE_VALID = _zz_162[0];
    if((decode_INSTRUCTION[11 : 7] == 5'h0))begin
      decode_REGFILE_WRITE_VALID = 1'b0;
    end
  end

  assign decode_LEGAL_INSTRUCTION = ({((decode_INSTRUCTION & 32'h0000005f) == 32'h00000017),{((decode_INSTRUCTION & 32'h0000007f) == 32'h0000006f),{((decode_INSTRUCTION & 32'h0000106f) == 32'h00000003),{((decode_INSTRUCTION & _zz_198) == 32'h00001073),{(_zz_199 == _zz_200),{_zz_201,{_zz_202,_zz_203}}}}}}} != 18'h0);
  always @ (*) begin
  ...
  assign IBusSimplePlugin_jump_pcLoad_payload = (_zz_163[0] ? CsrPlugin_jumpInterface_payload : BranchPlugin_jumpInterface_payload);
  always @ (*) begin
  ...
  always @ (*) begin
    IBusSimplePlugin_fetchPc_pc = (IBusSimplePlugin_fetchPc_pcReg + _zz_166);
    if(IBusSimplePlugin_jump_pcLoad_valid)begin
  ...
  assign IBusSimplePlugin_pending_next = (_zz_167 - _zz_171);
  ...
  assign _zz_123 = (IBusSimplePlugin_rspJoin_rspBuffer_output_ready || IBusSimplePlugin_rspJoin_rspBuffer_flush);
  assign IBusSimplePlugin_pending_dec = (IBusSimplePlugin_rspJoin_rspBuffer_c_io_pop_valid && _zz_123);
  ...
  always @ (*) begin
    ...
    if(memory_ALIGNEMENT_FAULT)begin
      DBusSimplePlugin_memoryExceptionPort_payload_code = {1'd0, _zz_176};
    end
  end
  ...
  assign _zz_75 = {({_zz_78,(_zz_215 == _zz_216)} != 2'b00),{((_zz_217 == _zz_218) != 1'b0),{(_zz_219 != 1'b0),{(_zz_220 != _zz_221),{_zz_222,{_zz_223,_zz_224}}}}}};
  ...
  assign decode_RegFilePlugin_rs1Data = _zz_125;
  assign decode_RegFilePlugin_rs2Data = _zz_126;
  always @ (*) begin
  ...
  always @ (*) begin
    case(execute_SRC1_CTRL)
      ...
      `Src1CtrlEnum_defaultEncoding_PC_INCREMENT : begin
        _zz_88 = {29'd0, _zz_178};
      end
      `Src1CtrlEnum_defaultEncoding_IMU : begin
        _zz_88 = {execute_INSTRUCTION[31 : 12],12'h0};
      end
      default : begin
        _zz_88 = {27'd0, _zz_179};
      end
    endcase
  end

  assign _zz_89 = _zz_180[11];
  always @ (*) begin
    _zz_90[19] = _zz_89;
    _zz_90[18] = _zz_89;
    _zz_90[17] = _zz_89;
  ...
  always @ (*) begin
    execute_SrcPlugin_addSub = _zz_182;
  ...
  assign execute_CsrPlugin_readData = (((_zz_117 | _zz_118) | (_zz_119 | _zz_120)) | (_zz_121 | _zz_122));
  assign _zz_124 = 1'b0;
  always @ (posedge clk or posedge reset) begin
    if (reset) begin
      ...
      IBusSimplePlugin_rspJoin_rspBuffer_discardCounter <= (IBusSimplePlugin_rspJoin_rspBuffer_discardCounter - _zz_173);
      if(IBusSimplePlugin_iBusRsp_flush)begin
        IBusSimplePlugin_rspJoin_rspBuffer_discardCounter <= (IBusSimplePlugin_pending_value - _zz_175);
      end
      `ifndef SYNTHESIS
        `ifdef FORMAL
      ...
      if(execute_CsrPlugin_csr_768)begin
        if(execute_CsrPlugin_writeEnable)begin
          ...
          CsrPlugin_mstatus_MPIE <= _zz_192[0];
          CsrPlugin_mstatus_MIE <= _zz_193[0];
        end
      end
      if(execute_CsrPlugin_csr_772)begin
        if(execute_CsrPlugin_writeEnable)begin
          CsrPlugin_mie_MEIE <= _zz_195[0];
          CsrPlugin_mie_MTIE <= _zz_196[0];
          CsrPlugin_mie_MSIE <= _zz_197[0];
        end
      end
    end
  end
